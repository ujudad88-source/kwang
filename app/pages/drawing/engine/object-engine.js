(function(){
  ...
  const registry=window.KENC_OBJECT_DEFINITIONS||{};
  ...
  function definition(type){return registry[type]||null;}
  ...
  function normalizeObject(input,cabinet){
    ...
    o.schemaVersion=1;o.variant=resolveVariant(o.type,o.option||o.variant);o.option=o.option||o.variant;
  ...
  function normalizeCabinet(c){c.objects=Array.isArray(c.objects)?c.objects:[];c.objects.forEach(o=>normalizeObject(o,c));c.schemaVersion=1;return c;}
  function normalizeState(s){if(!s||typeof s!=='object')return s;s.cabinets=Array.isArray(s.cabinets)?s.cabinets:[];s.cabinets.forEach(normalizeCabinet);s.engineVersion='1.0.3';return s;}
  ...
  window.KENC_OBJECT_ENGINE={version:'1.0.3',definition,resolveVariant,normalizeObject,normalizeCabinet,normalizeState,plane,clampObject,addObject,updateObject,removeObject,serialize,deserialize,on,emit};
})();
