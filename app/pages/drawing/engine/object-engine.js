(function(){
  ...
  function normalizeState(s){if(!s||typeof s!=='object')return s;s.cabinets=Array.isArray(s.cabinets)?s.cabinets:[];s.cabinets.forEach(normalizeCabinet);s.engineVersion='1.1.1';return s;}
  ...
  window.KENC_OBJECT_ENGINE={version:'1.1.1',definition,resolveVariant,normalizeObject,normalizeCabinet,normalizeState,plane,clampObject,addObject,updateObject,removeObject,serialize,deserialize,on,emit};
})();
